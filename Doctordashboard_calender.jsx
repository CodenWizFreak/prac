...
const Calendar = () => {
  const currentMonth = 8; // September (0-based index)
  const currentYear = 2024;
  const today = new Date(currentYear, currentMonth, 7); // September 7, 2024
  ...
  const renderCalendarDays = () => {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
      ...
      const isToday = getDate(date) === 7; // Highlight September 7
